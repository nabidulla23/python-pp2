...
pygame.display.set_caption("Artyom's racer game") #название экрана
clock = pygame.time.Clock()
global NUM_OF_COINS
NUM_OF_COINS = 0
score_font = pygame.font.SysFont("Verdana", 20) #шрифт для счетчиков
bg = pygame.image.load("lab9/AnimatedStreet.png") #background
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load('lab9/goldcoin.png')
...
class Treasure(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image=pygame.image.load('lab9/treasure.png')
